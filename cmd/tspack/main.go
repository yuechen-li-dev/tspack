...
func printHelp() {
	...
	fmt.Println("  tspack inspect <url> [--url <url>] [--browser auto|vscode|playwright-chromium|chromium|browser-path|cdp] [--browser-path path] [--cdp endpoint] [--list-targets] [--target index-or-id] [--target-url substring] [--viewport WxH] [--selector css] [--point x,y] [--json] [--out file] [--text file]")
}
