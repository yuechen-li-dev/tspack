...
- Future: add richer concept-authored projections/config, add a Shadcn local concept, add a Storybook local concept, add env/service/pack support for backend concepts, define possible built-in concept promotion criteria, and keep remote registry exploration much later.
