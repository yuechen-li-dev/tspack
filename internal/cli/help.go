...
func printCommandHelp(command string) {
	pages := map[string][]string{
		...
		"inspect":  {"tspack inspect", "Inspects browser/app/runtime targets (experimental).", "Use to inspect a URL or a RunTarget-backed app with browser backends.", "Usage:", "  tspack inspect <url> [experimental] [--run target] [--browser backend]", "Examples:", "  tspack inspect https://example.test", "  tspack inspect --run dev --bundle", "Important flags:", "  --run <target>        Start a RunTarget before inspecting", "  --browser <backend>   Select browser backend", "  --selector <css>      Inspect a selector", "  --json                Emit inspect JSON", "  --bundle              Emit deterministic UI context JSON", "  --bundle-output <file> Atomically replace a bundle file", "Related:", "  run             Start targets", "  test --run      Run xTest against a ready target", "  doctor inspect  Diagnose inspect setup"},
