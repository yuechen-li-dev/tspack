...
func builtinFragments() []Fragment {
	return []Fragment{
		...
		{Name: "react.app", Provides: []string{"react.app"}, Requires: []string{"typescript.app", "browser.spa"}, CompatibleKinds: []string{"app"}, Manifest: ManifestContributions{Dependencies: []DependencyContribution{dep("react", "^19.0.0"), dep("react-dom", "^19.0.0")}, Tools: []DependencyContribution{dep("@vitejs/plugin-react", "^4.0.0"), dep("@types/react", "^19.0.0"), dep("@types/react-dom", "^19.0.0")}, Concepts: []string{"react.app"}}},
		{Name: "browser.spa", Provides: []string{"browser.spa"}, CompatibleKinds: []string{"app"}, Manifest: ManifestContributions{Targets: []TargetContribution{{Name: "app", Export: ".", Entry: "src/main.tsx", Runtime: "dist/main.js", Types: "dist/main.d.ts"}}, Concepts: []string{"browser.spa"}}},
