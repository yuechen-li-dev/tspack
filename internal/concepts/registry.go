...
func builtinFragments() []Fragment {
	return []Fragment{
		...
		{Name: "react.app", Provides: []string{"react.app"}, Requires: []string{"typescript.app", "browser.spa"}, Conflicts: []string{"react.library"}, CompatibleKinds: []string{"app"}, Manifest: ManifestContributions{Dependencies: []DependencyContribution{dep("react", "^19.0.0"), dep("react-dom", "^19.0.0")}, Tools: []DependencyContribution{dep("@vitejs/plugin-react", "^4.0.0"), dep("@types/react", "^19.0.0"), dep("@types/react-dom", "^19.0.0")}, Concepts: []string{"react.app"}}},
		{Name: "browser.spa", Provides: []string{"browser.spa"}, Conflicts: []string{"react.library"}, CompatibleKinds: []string{"app"}, Manifest: ManifestContributions{Targets: []TargetContribution{{Name: "app", Export: ".", Entry: "src/main.tsx", Runtime: "dist/main.js", Types: "dist/main.d.ts"}}, Concepts: []string{"browser.spa"}}},
		...
		{Name: "typescript.library", Provides: []string{"typescript.library"}, CompatibleKinds: []string{"library"}, Manifest: ManifestContributions{Tools: []DependencyContribution{dep("typescript", "^5.0.0")}, RunTargets: []RunTargetContribution{{Name: "build-types", Command: "tsc -p tsconfig.build.json --listEmittedFiles"}, {Name: "typecheck", Command: "tsc -p tsconfig.json --noEmit --pretty false --diagnostics"}}, Concepts: []string{"typescript.library"}}},
		...
		{Name: "react.library", Provides: []string{"react.library"}, Requires: []string{"package.peerDependencies", "package.exports", "tspack.pack", "vite.library", "typescript.library"}, Conflicts: []string{"browser.spa", "react.app"}, CompatibleKinds: []string{"library"}, Manifest: ManifestContributions{Peers: []DependencyContribution{dep("react", "^19.0.0"), dep("react-dom", "^19.0.0")}, Tools: []DependencyContribution{dep("@vitejs/plugin-react", "^4.0.0"), dep("@types/react", "^19.0.0"), dep("@types/react-dom", "^19.0.0")}, Targets: []TargetContribution{{Name: "library", Export: ".", Entry: "src/index.ts", Runtime: "dist/index.js", Types: "dist/index.d.ts"}}, Concepts: []string{"react.library"}}},
