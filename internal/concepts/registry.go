...
func builtinFragments() []Fragment {
	return []Fragment{
		...
		{Name: "tspack.manifestBoundary", Provides: []string{"tspack.manifestBoundary"}, Requires: []string{"tspack.workspace"}, Manifest: ManifestContributions{Concepts: []string{"tspack.manifestBoundary"}}},
