...
- Generators and test setup do not rewrite unchanged generated bytes or shared fixture inputs.
...
- The broad Go developer command is `go test ./cmd/... ./internal/... ./tools/...`. Do not use repository-root `./...` for normal validation because generated `dist` trees are outside the Go source roots and can make package discovery pathologically slow.
