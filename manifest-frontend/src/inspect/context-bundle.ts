...
type InspectBounds = Bounds;
type InspectNode = UIInspectNode;
type InspectResult = UIInspectResult;
type InspectSourceHint = UISourceHint;
type InspectDiagnostic = UIInspectResult['diagnostics'][number];
