...
7. If the selected node has a parsed source hint, use **TSPack: Reveal Source for Selected Inspect Node** to open the existing workspace file at the hinted location.
